...
import algoritmosDeProcessamentoDeImagens.Panel_Transformacao_Negativo;
...
public class TelaTransformacaoNegativo extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	Panel_Transformacao_Negativo panelDaImagem2 = new Panel_Transformacao_Negativo();
	
	public TelaTransformacaoNegativo(){
		setSize(1024, 720);
		setLayout(null);
		setVisible(true);
...
botaoMenuFiltros.addActionListener(new ActionListener() {
		...
		// Corpo do sistema
		JLabel labelTransformacaoNegativo = new JLabel("Transformação > Negativo");
		labelTransformacaoNegativo.setForeground(Color.WHITE);
		labelTransformacaoNegativo.setFont(new Font("Segoe UI Semilight", Font.PLAIN, 24));
		labelTransformacaoNegativo.setBounds(10, 24, 730, 55);
		panelSuperior.add(labelTransformacaoNegativo);
