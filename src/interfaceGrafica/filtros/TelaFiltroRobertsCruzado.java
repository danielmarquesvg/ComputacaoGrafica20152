...
import algoritmosDeProcessamentoDeImagens.Panel_Filtros_RobertsCruzado;
...
public class TelaFiltroRobertsCruzado extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	Panel_Filtros_RobertsCruzado panelDaImagem2 = new Panel_Filtros_RobertsCruzado();
	
	public TelaFiltroRobertsCruzado(){
		setSize(1024, 720);
		setLayout(null);
		setVisible(true);
