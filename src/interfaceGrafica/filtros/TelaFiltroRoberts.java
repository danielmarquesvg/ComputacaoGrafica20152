...
import algoritmosDeProcessamentoDeImagens.Panel_Filtros_Roberts;
...
public class TelaFiltroRoberts extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	Panel_Filtros_Roberts panelDaImagem2 = new Panel_Filtros_Roberts();
	
	public TelaFiltroRoberts(){
		setSize(1024, 720);
		setLayout(null);
		setVisible(true);
