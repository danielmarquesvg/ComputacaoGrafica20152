...
import algoritmosDeProcessamentoDeImagens.Panel_Filtros_Media;
...
import interfaceGrafica.operadores.TelaOperadoresAritmeticos;
...
public class TelaFiltroMedia extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	Panel_Filtros_Media panelDaImagem2 = new Panel_Filtros_Media();
	
	public TelaFiltroMedia(){
		setSize(1024, 720);
		setLayout(null);
		setVisible(true);
