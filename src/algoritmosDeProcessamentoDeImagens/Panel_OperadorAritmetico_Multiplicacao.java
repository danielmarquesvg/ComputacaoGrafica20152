...
public class Panel_OperadorAritmetico_Multiplicacao extends JPanel {

	public BufferedImage imagemMultiplicacao;
	
	/**
	 * Create the panel.
	 */
	public Panel_OperadorAritmetico_Multiplicacao() {
	...
	public void geraImagem(int alturaDaImagem1, int larguraDaImagem1, int matrizDaImagem1[][], int alturaDaImagem2, int larguraDaImagem2, int matrizDaImagem2[][]) throws Exception{
         ...
         * utiliza a menor resolucao como padrao da resolucao da imagem processada com a operacao de multiplicacao
         */
        ...
        imagemMultiplicacao = new BufferedImage(altura, largura, BufferedImage.TYPE_INT_RGB);
        ...
        for(int i = 0; i<altura; i++){
        	for(int j=0;j<largura;j++){
        		...
        		imagemMultiplicacao.setRGB(j, i, corPixel(matrizImagem[i][j]));
        		repaint();
        	}
        } 
    }
	...
	protected void paintComponent(Graphics g) {
		...
		g.drawImage(imagemMultiplicacao, 0, 0, null);
	}
