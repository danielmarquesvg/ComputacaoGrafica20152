...
public class CircunferenciaExplicita extends JFrame {//Janela que obtem as informações para criação da circunferencia
	...
	public CircunferenciaExplicita() {//Será criado usando o algoritmo explicito
		...
		JLabel lblCircunferenciaAlgoritmo = new JLabel("Circunferencia - Algoritmo explicita");
		...
		btnDesenhar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Ponto> listaPontos = new Circunferencia(0, 0, raio).circ_explicita(0, 0, raio);
