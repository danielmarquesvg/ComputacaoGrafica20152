...
public class TelaPrincipal extends JFrame {
	...
	/**
	 * Lista de {@link Ponto} em 2D (duas dimens̵es)
	 */
	public static List<Ponto> listaGLOBAL = new ArrayList<Ponto>();
	/**
	 * Lista de {@link Ponto3D} em 3D (tr̻s dimens̵es).
	 */
	...
	public static void povoar3D(Color cor) {
		...
		for (Ponto3D ponto : getListaGLOBAL3D()) {
			try {
				...
				System.out
						.println("Erro ao povoar os valores nas 3 dimens̵es.");
			}
		}
	...
	/**
	 * @return the lista em 2D (Duas dimens̵es)
	 */
	...
	/**
	 * Lista de coordenadas em 3D (Tr̻s dimens̵es)
	 * 
