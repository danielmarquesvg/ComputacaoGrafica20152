...
public class ReflexaoReta extends JFrame{//Tela da reflex„o da reta, obtem os dados do usu·rio
	/**
	 * 
	 */
	...
	public ReflexaoReta() {
		...
		btnOk.addActionListener(new ActionListener() {//Evento que faz a operaÁ„o
