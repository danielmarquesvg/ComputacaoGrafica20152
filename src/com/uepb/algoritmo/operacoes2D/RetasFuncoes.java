...
//Classe referente as retas
	...
	/**
	 * Algoritmo do declive. Utiliza-se da equaÁ„o fundamental da reta (y = mx+b)
	 * 
	 * @param x1
	 * @param y1
	 * @param x2
	...
	//Os mÈtodos a seguir s„o para imprimir as retas em todos os octantes
	 ...
	 * @param y
	 */
	private void setPixel(double x, double y) {//MÈtodo primordial, adiciona um pixel
		listaDePontos
	 ...
	 * @param y2
	 */
	public List<Ponto> retaPontoMedio(int x, int y, int x2, int y2) {//Ponto mÈdio
		int wigth = x2 - x;
		int height = y2 - y;
